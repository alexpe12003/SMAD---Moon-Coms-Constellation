...
# Lambert's problem solver using universal variable formulation and knowing R1 and R2 position Vectors and time of flight t
def lambert(R1, R2, t, string, mu):
    ...
    r1 = np.linalg.norm(R1)  # Magnitude of initial position vector
    r2 = np.linalg.norm(R2)  # Magnitude of final position vector
    ...
    return V1, V2, theta1, theta2  # Return velocity vectors and true anomalies
