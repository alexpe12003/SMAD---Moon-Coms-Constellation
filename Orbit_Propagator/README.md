...
├── examples/               # Example usage and main simulations
│   ├── main_simulation.py  # Primary Orbit B convergence study
│   ├── rk_comparison.py    # RK4 vs RK8 comparison
│   └── project_summary.py  # Project overview generator
...
python examples/main_simulation.py

# Algorithm comparison
python examples/rk_comparison.py

# Verification tests
python verification/RK4_verification.py
python verification/RK8_verification.py
```
...
- **Technical References**: `/docs` directory (mathematical foundations)
- **API Documentation**: Inline docstrings in all modules
- **Examples**: `/examples` directory (practical usage)

### Getting Help
- **Code Issues**: Check verification scripts first
- **Mathematical Questions**: See technical references
- **Usage Examples**: Browse `/examples` directory
